...
urlpatterns = [
    ...
    path('feedbacks/<int:feedback_id>/acknowledge/', views.acknowledge_feedback, name='acknowledge_feedback'),
    path('feedbacks/<int:feedback_id>/edit/', views.edit_feedback, name='edit_feedback'),
